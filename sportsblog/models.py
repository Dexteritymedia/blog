...
from core.blocks import PageSectionStoryBlock, StoryBlock
...
class BlogDetailPage(Page):
    ...
    parent_page_types = [
        'sportsblog.BlogIndexPage', 'sportsblog.BlogListingPage'
    ]
    ...
    tags = ClusterTaggableManager(through="sportsblog.BlogPostPageTag", blank=True)
    ...
    related_services = ParentalManyToManyField(
        "sportsblog.Service", related_name="blog_posts", blank=True,
    )
...
class BlogPostPageTag(TaggedItemBase):
    content_object = ParentalKey("sportsblog.BlogDetailPage", related_name="post_tags")


class BlogCategory(models.Model):
    page = ParentalKey('sportsblog.BlogDetailPage', on_delete=models.CASCADE, related_name='blog_categories')
    blog_category = models.ForeignKey(
        'sportsblog.BlogCategory', on_delete=models.CASCADE, related_name='blog_pages')
